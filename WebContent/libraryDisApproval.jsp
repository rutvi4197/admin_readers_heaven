                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                         ...
                         <%List<library_joinBean>b=(ArrayList)request.getAttribute("listOfLibrary");
							if(b==null){ %>
							 <jsp:forward page="/disapproveLibraryListServelt?action=libraryDisApproval.jsp" />
		 					<% }else{
							...
							%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="./deleteLibraryServelt?id=<%=book.getLibrary_address_id() %>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                    </td>
                                </tr>
                                <% }
		 						} %>
