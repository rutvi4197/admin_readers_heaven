 ...
 */
public class disapproveLibraryListServelt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public disapproveLibraryListServelt() {
    //    super();
	...
	//	System.out.println("happy birthday");
		...
		String str=request.getParameter("action");
			...
			listOfLibrary = new libraryApprovalDao().getDisapproveLibrary();
